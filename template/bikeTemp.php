<?php
$_SESSION['message'] = '#modalbike';
if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true){
    $_SESSION['message'] ='rent?id=';
  // $_SESSION['message'] = 'index.php?page=rent&id=';
  }
           $row = $SelectVechile->validation('vechile_type','Motor Bike');
           $total = $row->fetchColumn();
            ...
            $limit = $resultt->limitfind('vechile_type','Motor Bike',$start,$limit);
            ...
            foreach ($limit as $row) {
              ...
              <h5>Type<i style="width: 85px;" class="fa fas fa-motorcycle deticon"><?php echo $row['vechile_type']; ?></i></h5>
              ...
              <a href="#alertbike" class="bookbox-btn">Book Now</a>
              <?php }else{?>
  ...
  <ul class="pagination" style="float: right; margin-right: 3%;">
    ...
    <li class="page-item">
      <?php if($id > 1){ ?>
      <a class="page-link" href="?bid=<?php echo ($id-1); ?>">Previous</a>
    </li>
    <?php } ?>
    ...
    <?php if($id != $page){ ?>
      <a class="page-link" href="?bid=<?php echo ($id+1); ?>">Next</a>
    </li>
    <?php } ?>
  
  </ul>
               <div class="lightbox" id="modalbike">
            <div class="lightbox-container">
              ...
              <div class="lightbox" id="alertbike">
            <div class="lightbox-container">
              <a href="#" class="lightbox-close"><i class="fa fa-window-close"></i></a>
              <div class="lightbox-content">
                <div class="lightbox-content__title">
