<?php
$_SESSION['message'] = '#modalatv';
if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true){
    $_SESSION['message'] ='rent?id=';
  // $_SESSION['message'] = 'index.php?page=rent&id=';
  }

           $row = $SelectVechile->validation('vechile_type','ATV Bike');
           $total = $row->fetchColumn();
            ...
            $limit = $resultt->limitfind('vechile_type','ATV Bike',$start,$limit);
            ...
            foreach ($limit as $row) {
              ...
              <a href="#alertatv" class="bookbox-btn">Book Now</a>
              <?php }else{?>
...
<ul class="pagination" style="float: right; margin-right: 3%;">
    ...
    <li class="page-item">
      <?php if($id > 1){ ?>
      <a class="page-link" href="?id=<?php echo ($aid-1); ?>">Previous</a>
    </li>
    <?php } ?>
   
    <!--how many page making total data field-->
    <?php if($id != $page){ ?>
      <a class="page-link" href="?id=<?php echo ($aid+1); ?>">Next</a>
    </li>
    <?php } ?>
  
  </ul>

            <div class="lightbox" id="modalatv">
            <div class="lightbox-container">
              ...
              <div class="lightbox" id="alertatv">
            <div class="lightbox-container">
              <a href="#" class="lightbox-close"><i class="fa fa-window-close"></i></a>
              <div class="lightbox-content">
                <div class="lightbox-content__title">
